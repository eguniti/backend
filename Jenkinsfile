node{
    ...
    stage('Build Image and push to ECR'){
        ...
        sh 'docker tag backend/$JOB_NAME:v1.$BUILD_NUMBER 186319575019.dkr.ecr.us-east-1.amazonaws.com/backend:v1.$BUILD_NUMBER'
        ...
        sh 'docker push 186319575019.dkr.ecr.us-east-1.amazonaws.com/backend:v1.$BUILD_NUMBER'
    }
}
